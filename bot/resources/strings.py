lang_dict = {
    ...
    "select region of contact": ["🗺 Hududni tanlang", "🗺 Выберите регион"],
    ...
    "feedback": ["📩 Bog'lanish", "📩 Обратная связь"],

    "write your feedback": [
        "Biz bilan bog'lanish uchun xabaringizni yozib qoldiring", 
        "Мы будем рады услышать вас! Напишите свое сообщение ниже, чтобы связаться с нами"
        ],
    ...
    "not_have": ["Ma'lumot mavjud emas", "Информация отсутствует"],
